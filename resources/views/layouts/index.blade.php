                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('menus.index') }}" class="{{ Request::routeIs('menus.index') ? 'active' : '' }}">Menu List</a>
                                </li>
                                <li>
                                    <a href="{{ route('menus.create') }}" class="{{ Request::routeIs('menus.create') ? 'active' : '' }}">Create Menu</a>
                                </li>
                                <li>
                                    <a href="{{ route('categories.index') }}" class="{{ Request::routeIs('categories.index') ? 'active' : '' }}">Category List</a>
                                </li>
                                <li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="{{route('users.index')}}" class="{{ Request::routeIs('users.index') ? 'active' : '' }}">Employee List</a></li>
                                <li><a href="{{route('users.create')}}" class="{{ Request::routeIs('users.create') ? 'active' : '' }}">Add Employee </a></li>
                            </ul>
                        </li>
                        <li class="submenu">
