                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        ...
                                        <img src="{{ asset('storage/image/' . $category->image) }}" alt="product">
                                    </a>
                                    <a href="javascript:void(0);">{{ $category->name }}</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0);">{{ $category->menus->count() }}</a>
                                </td>
                                <td>
                                    ...
                                    <form id="delete-form-{{ $category->id }}"
                                        action="{{ route('menus.destroy', $category->id) }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
